    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Stuff.stuff_degrees')),
                ('dept', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='Departments.department')),
            ],
        ),
        migrations.CreateModel(
            name='Students',
            fields=[
                ...
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Basic_data.college')),
                ('dept', models.ForeignKey(default=4, on_delete=django.db.models.deletion.CASCADE, to='Departments.department')),
                ('grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Departments.college_grades')),
                ('nationality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Basic_data.nationality')),
